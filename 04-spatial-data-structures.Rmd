...
Plotting the sf-object metadata in the console reveals that `Geometry type` is `Multipoint` and that no coordinate reference system has been defined (CRS: NA):
