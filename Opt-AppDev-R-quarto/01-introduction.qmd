...
::: {#fig-vid}
<iframe src="https://youtu.be/FIrsOBy5k58?si=xOVK37QKWTBsAnJ1" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen>
...
With RStudio and R installed, let's dive into coding. The **Console Window** in @fig-vid2 is where the interpreter outputs results based on your input.
::: caption

![Console Window in RStudio](images/Console.png){#fig-vid2}
...
::: {.exercisebox title="Exercise: Calculate the Area of a Polygon"}
