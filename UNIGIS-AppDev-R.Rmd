...
<!--chapter:end:01-introduction_to_r.Rmd-->
...
<!--chapter:end:02-core_concepts.Rmd-->
...
The second family of control structures that we a going to discuss in this lesson are loops. Loops are a fundamental component of (procedural) programming. They allow repeating one or more instructions multiple times.
...
<!--chapter:end:04-control_structures.Rmd-->
...
<!--chapter:end:06-selection_filtering.Rmd-->
...
For accessing the data, we need to create a URL that is composed of a references to the data source (base) and parameters to filter the desired data subset (lat and lon). The parameters are concatenated by means of a '&' symbol, a question mark '?' needs to be placed between reference URL and parameters: 
