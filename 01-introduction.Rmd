...
This module will equip you with fundamental R programming skills, starting with core programming concepts universal to most languages, including **Datatypes**, **Operators**, **Variables**, **Functions**, **Control Structures**, and **Libraries**.

We will then delve into more advanced data types such as **Data Frames** and **Tibbles**, and learn methods to **Read and Write** both spatial and non-spatial datasets. You'll learn to manipulate data that may initially seem unsuitable for your analyses by **filtering, querying, subsetting, joining, and reshaping** it.

The module progresses to data **visualization**, teaching you to create informative diagrams (e.g., box plots, scatterplots, line plots) and maps. 

Upon completing this module, you'll possess foundational R programming skills, preparing you for advanced topics like Geospatial Data Analysis (covered in the "Spatial Statistics" module of the MSc program).
