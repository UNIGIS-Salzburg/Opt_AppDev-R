...
- *The terra package.* see [Online Documentation](https://rspatial.org/pkg/index.html){target="_blank"}
- *Sf - Simple Features for R.* see [Online Documentation](https://r-spatial.github.io/sf/){target="_blank"}
