...
**Tables** are created by using the symbols `|` and `-`. Do you remember in the first chapter, the [numeric operators table](#numop)? Figure \@ref(fig:L09-tables) illustrates the RMarkdown syntax being used to create this table. 
