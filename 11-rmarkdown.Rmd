...
Use the dropdown next to the **Knit** button to compile into `PDF` or `.docx` formats, among [others](https://rmarkdown.rstudio.com/lesson-9.html){target="_blank"}.
...
The vast functionalities of R Markdown extend beyond the scope of a single lesson. To fully leverage its capabilities, refer to the comprehensive online book [R Markdown: The Definitive Guide](https://bookdown.org/yihui/rmarkdown/){target="_blank"}.
