...
As you saw in chapter 8 - data visualization. We of course can also use graphical elements in our .Rmd file.

Before we begin, make sure you have the ggplot2 library installed and loaded in your R environment. You can install ggplot2 by running `install.packages("ggplot2")` in the R console. Then, load the library by running `library(ggplot2)`.
