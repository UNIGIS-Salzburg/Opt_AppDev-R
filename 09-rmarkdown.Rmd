...
Once you have successfully implemented the setup, you can create your first RMarkdown document. 

```{block2, type = 'rmdexercise'}

As a first step, we will create a local clone from our Online GitHub repository. In RStudio: File -> New Project... -> Version Control -> Git.

Copy/past the Repository URL (go to your Online repository to find URL), browse local directory and `Create Project`.
