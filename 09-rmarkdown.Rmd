...
```{r L09-updated, echo=FALSE, fig.cap="Commit with message 'decribe sync process in github' was pushed to the developer branch of this repository 1 minute ago", out.width='90%', fig.asp=.75, fig.align='center'}
