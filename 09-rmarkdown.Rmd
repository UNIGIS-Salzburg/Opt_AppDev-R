...
3) [Download and install Git](https://git-scm.com/downloads){target="_blank"}. [Git](https://docs.github.com/en/get-started/quickstart/set-up-git){target="_blank"} is responsible for everything GitHub-related that happens locally on your machine.If you are interested, this  [video](https://www.youtube.com/watch?v=uR6G2v_WsRA){target="_blank"} gives a very nice explanation of core concepts in Git.
