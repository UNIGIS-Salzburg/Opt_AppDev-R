...
The values 4 and 6 are returned. These values have the indices 2 and 4 in vector 'a_vector'. Note that the vector containing the indices 2 and 4 is created on the fly (without variable assignment).
...
, select the last three cities out of the four cities in 'east_midlands_cities' by means of an vector of indices and assign the returned values to a new vector named 'selected_cities'.
