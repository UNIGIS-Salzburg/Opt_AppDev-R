...
```{block2, type = 'rmdtip'}
Note that statement 1 and statement 2 are in curly brackets! The indentation of statements is good programming practice, however has does not affect the functioning of the code.
```
