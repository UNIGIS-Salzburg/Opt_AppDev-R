...
If you type a simple numeric operation in the console (e.g. 2 + 4), the interpreter will return a result. This indicates that operations (e.g. mathematical calculations) can be carried on these types.
...
The interpreter returns 'TRUE', because 2 is less than 3.
...
Whereas mathematical operators are self-explanatory, the operators 'Module' and 'Integer disision' may be new to some of you. In integer division, the dividend is divided by the divisor into an integer quotient:
