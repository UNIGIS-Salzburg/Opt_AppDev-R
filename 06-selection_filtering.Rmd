...
5. Join tables (left table: geographic features, right table: sorghum production statistics) based on country names. Make sure to chose a join method that allows for retaining all the geographic features. 
