...
To carry out binary operations, we first create a second sf-object that contains the location of farmsteads in our study area (`bbox=14,48,14.02,48.02`). The data is in turn loaded via the [AMA Rest API service](https://gis.lfrz.gv.at/ogcapi009501/ogc/features/collections?f=text%2Fhtml){target="_blank"}:
