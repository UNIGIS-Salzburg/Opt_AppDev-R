...
You may have noticed that the extent in y-direction of the returned subset is larger than specified in the code above (raster resolution = 40m). This is because only entire cells can be selected. To circumvent this problem we can either change the cropping extent (e.g. 180000, 180200, 331000, 331200) or modify the spatial resolution of `r`.
