...
Default parameters can enhance a function's flexibility. Modify `area_rectangle` to default `width` to `3`. With only one input, the function should return `YOUR INPUT * 3`. Specifying both parameters overrides the default `width`.
