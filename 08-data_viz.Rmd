...
Data can be mapped onto visual variables in the same way as with diagram plots. In the example below, the variable AREA is mapped onto visual variable fill color:
...
create final appealing map: north arrow, scale bar, legend, annotations
