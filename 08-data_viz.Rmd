...
we read in shape data by sf and created simple map layouts in lesson read and write data
also in exercise 6.3.1. we created a simpe map

base map: geom_sf function, which simply adds a geometry stored in a sf object
...
ggplot(data = nc)+
    ...
    ggtitle("World map", subtitle = paste0("(", length(unique(nc$NAME)), " counties)"))
...
```{r, echo=TRUE, message=FALSE, warning=FALSE, fig.height = 4}
ggsave("data/map.pdf")
ggsave("data/map_web.png", width = 6, height = 6, dpi = "screen")
```
